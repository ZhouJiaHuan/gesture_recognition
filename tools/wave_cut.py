...
def split_points(points, rel_min, rel_max, txt_dir):
    ...
    for i, ma in enumerate(max_array[:-1]):
        if np.max(min_array) > ma:
            ...
            txt_name = "wave_" + str(i) + '-' + str(ma) + '-' + str(mi) + '.txt'
...
if __name__ == "__main__":
    wave_dir = "/home/zhoujh/Data/gesture_recognition/bag_files/wave"
    out_dir = "/home/zhoujh/Data/gesture_recognition/bag_files/wave_out"
    # split(wave_dir, out_dir, col=17)  # rhand y
    split(wave_dir, out_dir, col=31, ext='*trt-18.txt')  # rhand y for trt-pose-body-18
